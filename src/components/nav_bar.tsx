                            ...
                            <div className="framer-ixQHd framer-M4SXU framer-E4PKR framer-t4vk4g framer-v-t4vk4g"
                                ...
                                <nav className="framer-1tf43wt" data-border="true" data-framer-name="menubar"
                                    ...
                                    <div className="framer-1te8jbc-container" style={{opacity: 1}}>
                                        <div className="framer-96WSQ framer-o51aiz framer-v-o51aiz"
                                            data-framer-name="Variant 1" data-highlight="true" tabIndex={0}
                                            style={{height: '100%', width: '100%', opacity: 1}}>
                                            <div className="framer-16f30ka-container" style={{opacity: 1}}>
                                                <div className="framer-IEW64 framer-1kf91e0 framer-v-1kf91e0"
                                                    data-framer-name="Dark"
                                                    style={{height: '100%', width: '100%', opacity: 1}}>
                                                    <div className="framer-15pp94k-container" style={{opacity: 1}}>
                                                        <div style={{display: 'contents'}}><svg
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"
                                                                focusable="false"
                                                                color="var(--token-4769c37a-e483-4cd7-ac6b-55da2c10d7ad, rgb(133, 133, 133))"
                                                                style={{userSelect: 'none', width: '100%', height: '100%', display: 'inline-block', fill: 'var(--token-4769c37a-e483-4cd7-ac6b-55da2c10d7ad, rgb(133, 133, 133))', color: 'var(--token-4769c37a-e483-4cd7-ac6b-55da2c10d7ad, rgb(133, 133, 133))', flexShrink: 0}}>
                                                                <g color="var(--token-4769c37a-e483-4cd7-ac6b-55da2c10d7ad, rgb(133, 133, 133))"
                                                                    data-weight="bold">
                                                                    <path
                                                                        d="M236.37,139.4a12,12,0,0,0-12-3A84.07,84.07,0,0,1,119.6,31.59a12,12,0,0,0-15-15A108.86,108.86,0,0,0,49.69,55.07,108,108,0,0,0,136,228a107.09,107.09,0,0,0,64.93-21.69,108.86,108.86,0,0,0,38.44-54.94A12,12,0,0,0,236.37,139.4Zm-49.88,47.74A84,84,0,0,1,68.86,69.51A84.93,84.93,0,0,1,92.27,48.29Q92,52.13,92,56A108.12,108.12,0,0,0,200,164q3.87,0,7.71-.27A84.79,84.79,0,0,1,186.49,187.14Z">
                                                                    </path>
                                                                </g>
                                                            </svg></div>
                                                    </div>
