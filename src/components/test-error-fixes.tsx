...
// Test component to verify our error fixes
export function TestErrorFixes() {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 space-y-2 rounded bg-black/80 p-4 text-white">
      ...
      {/* Test ViewportAnimation with various variants */}
      <div className="space-y-1">
        ...
        <ViewportAnimation variant={"invalidVariant" as any}>
          <div className="text-xs">Invalid variant (should fallback)</div>
        </ViewportAnimation>
      </div>
