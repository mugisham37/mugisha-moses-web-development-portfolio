    ...
    return (
        <div className="framer-1x6xwdf-container">
            <div className="framer-eqjhZ framer-pPjcC framer-M4SXU framer-LHxgI framer-hjedka framer-v-hjedka"
                data-framer-name="Variant 1" style={{ opacity: 1 }}>
                <div className="framer-8n9uni" data-framer-name="Name" style={{ opacity: 1 }}>
                    <div className="framer-1cqkper" data-framer-name="Category"
                        style={{ borderRadius: '101.82px', opacity: 1 }}>
                    ...
                    <div className="framer-1xvoydz" data-framer-name="Frame 13" style={{ opacity: 1 }}>
                        <div className="framer-iq3qqg" data-framer-name="Frame 12" style={{ opacity: 1 }}>
                            <div className="framer-wcws2k" data-framer-name="Title"
                ...
                <div className="framer-1q5e0wt" data-framer-name="Description"
                    data-framer-component-type="RichTextContainer"
