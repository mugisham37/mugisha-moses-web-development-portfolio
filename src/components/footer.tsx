    ...
    <div className="ssr-variant hidden-hfs46s hidden-10mb1y6">
                <div className="framer-1uflfkc-container">
                    <footer className="framer-ikq6M framer-M4SXU framer-E4PKR framer-3Wby5 framer-x3qah6 framer-v-1wtjzwr"
                        data-framer-name="Footer Small" style={{width: '100%', opacity: 1}}>
                        <div className="framer-1lu5t8w" data-border="true" data-framer-name="Contact"
                            ...
                            <div className="framer-5hxk0b" data-framer-name="Text" style={{opacity: 1}}>
                                <div className="framer-1ykoo4l" data-framer-name="Title"
                                    data-framer-component-type="RichTextContainer" style={{transform: 'none', opacity: 1}}>
                            ...
                            <div className="framer-1t177bx" data-framer-name="Social Media Column" style={{opacity: 1}}>
                                <div className="framer-1xdyvll-container" style={{opacity: 1}}><a
                                        ...
                                        rel="noopener" style={{height: '100%', borderRadius: '14px', opacity: 1}}>
                                            ...
                                            <div className="framer-9wbe8q" data-border="true"
                                                ...
                                                <div className="framer-zxr3e-container" style={{opacity: 0.8}}>
                                                    <div className="framer-dNIfb framer-1n00dmi framer-v-7qsfcq"
                                                        data-framer-name="2XS - 16x16" style={{opacity: 1}}>
                                ...
                                <div className="framer-p8l2ew-container" style={{opacity: 1}}><a
                                        className="framer-hjnqN framer-12r1jn2 framer-v-12r1jn2 framer-1yuywft"
                                ...
                                <div className="framer-e7zgmv-container" style={{opacity: 1}}><a
                                        className="framer-hjnqN framer-12r1jn2 framer-v-12r1jn2 framer-1yuywft"
                                ...
                                <div className="framer-1rwfixy-container" style={{opacity: 1}}><a
                                        className="framer-hjnqN framer-12r1jn2 framer-v-12r1jn2 framer-1yuywft"
                        ...
                        <div className="framer-blpivt" data-framer-name="Container" style={{opacity: 1}}>
                            ...
                            <div className="framer-r1so70" data-framer-name="Made with Framer from"
                                data-framer-component-type="RichTextContainer"
                                style={{'--extracted-r6o4lv': 'var(--token-7a188dfa-68d3-41d9-8d6c-67b23199941d, rgb(113, 113, 122))', transform: 'none', opacity: 1} as React.CSSProperties}>
                                <p className="framer-text framer-styles-preset-1y43b4w" data-styles-preset="SbUeepJXi"
