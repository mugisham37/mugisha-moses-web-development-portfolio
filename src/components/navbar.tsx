...
const NAV_LINKS: NavLink[] = [
    { href: '/', label: 'Home', className: 'framer-o6xkua', isCurrent: true },
    { href: '/about-me', label: 'About me', className: 'framer-1ru0n5c' }
];
...
const NavLinkItem: React.FC<NavLink> = ({ href, label, className, isCurrent }) => (
    <div
        className={className}
